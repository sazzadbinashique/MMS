                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            {!! Form::model($additional,['method'=>'PATCH', 'action'=> ['AdditionalsController@update', $additional->id],'role'=>'form'])!!}
                            {{ Form::hidden('id') }}
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group{{$errors->has('amount')? 'has-error': ''}}">
                                        ...
                                        {!! Form::number("amount", null, ['class' => 'form-control', 'placeholder'=> 'Enter Extra Amount...', 'id'=>'amount']) !!}
